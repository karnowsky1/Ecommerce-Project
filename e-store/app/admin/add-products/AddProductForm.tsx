...
const AddProductForm = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async(data) => {
    ...
    axios.post("/api/product", productData).then(()=> {
      ...
      toast.error("Something went wrong when saving product to the db")
    }).finally(()=> {
      setIsLoading(false)
    })
  }
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col flex-wrap gap-4">
        <div>
          <div className="font-bold">Select the available product colors and updload thier images.</div>
